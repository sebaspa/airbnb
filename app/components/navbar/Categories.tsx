...
export const categories = [
  ...
  },
  {
    label: "Camping",
    icon: GiForestCamp,
    description: "This property has a camping activities nearby",
  },
  {
    label: "Arctic",
    icon: BsSnow,
    description: "This property has a arctic activities nearby",
  },
  {
    label: "Caves",
    icon: GiCaveEntrance,
    description: "This property has a caves activities nearby",
  },
  {
    label: "Desert",
    icon: GiCactus,
